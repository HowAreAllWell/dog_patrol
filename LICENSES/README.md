...
- `docs/perception/tracking/**` 和 `assets/models/manifests/tracking_core_requirements.txt`
  是随上述 Apache-2.0 tracking 组件迁入或由其改写的材料，按 Apache-2.0 分发。

tracking 来源仓未提供 NOTICE 文件或文件级版权头，因此本仓不虚构 NOTICE；来源与修改说明见
`docs/perception/tracking/import_provenance.md`。
