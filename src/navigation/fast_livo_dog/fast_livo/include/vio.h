...
public:
    ...
    void retrieveFromVisualSparseMap(cv::Mat img, vector<pointWithVar>& pg,
    ...
    void getWarpMatrixAffineHomography(const vk::AbstractCamera& cam, const V2D& px_ref, const V3D& xyz_ref,
