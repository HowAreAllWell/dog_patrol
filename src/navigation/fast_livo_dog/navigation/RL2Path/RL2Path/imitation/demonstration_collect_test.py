...
def main():
    ...
    model = PPO.load("outputs/ckpts/tcnn_v0/model_12.zip", device="cuda")
    ...
    for i in range(30):
        ...
        control_points = np.vstack(([0, 0], cart_points, goal))
        ...
        visualize_costmap_and_path(costmap, path, params, controll_points=control_points, goal=goal, title=f"Path_{i}")
