...
def generate_order_10_bernstein_coefficients(n, tmin, tmax, t_actual):
    ...
    t = (np.asarray(t_actual, dtype=np.float32) - tmin) / (time_diff if time_diff != 0 else 1.0)
    ...
    P = np.column_stack((P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10))

    Pdot = np.column_stack((P0dot, P1dot, P2dot, P3dot, P4dot, P5dot, P6dot, P7dot, P8dot, P9dot, P10dot)) / (
        time_diff if time_diff != 0 else 1.0
    )

    Pddot = np.column_stack(
        (P0ddot, P1ddot, P2ddot, P3ddot, P4ddot, P5ddot, P6ddot, P7ddot, P8ddot, P9ddot, P10ddot)
    ) / ((time_diff if time_diff != 0 else 1.0) ** 2)
