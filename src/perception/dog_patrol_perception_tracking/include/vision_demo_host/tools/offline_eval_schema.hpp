...
inline std::string Phase3ShadowStateCsvHelp() {
  return
      ...
      "  With --sid-enable-phase5-birth-manager=true, hidden/pending/accepted birth decisions are\n"
      "  expressed by the Phase 5 path behind IdentityManager, with accepted allocation recorded as\n"
      "  stage=phase5_new_semantic; false keeps LegacyIdentityMatcher birth_candidate/new_semantic rollback.\n"
